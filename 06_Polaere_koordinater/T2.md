...
Med denne kode kan du plotte punkter givet i polære koordinater $(r, \theta)$ i et kartesisk koordinatsystem. Bemærk, at vinklerne kan angives i grader eller radianer, afhængigt af `is_degrees`-parameteren.
